...
public class DepoyaIade extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_depoya_iade);
        ...
        editBarcode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                IntentIntegrator integrator = new IntentIntegrator(DepoyaIade.this);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_peron) {
            ...
            final AlertDialog.Builder builder= new AlertDialog.Builder(DepoyaIade.this);
    ...
    private void getPostId(final String newBarkodMiktar2) {
        ...
        Volley.newRequestQueue(DepoyaIade.this).add(istek);
    }
